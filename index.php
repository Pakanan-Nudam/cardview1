        ...
        <div class="container">  
               <div class="card">
                ...
                <div class="row">
                     ...
                     <input type="text" id="lo" placeholder="Latitude" class="form-control" style="text-align: center;" >
                     <a>
                   <center>    <button id="search" class="btn btn-primary" style="margin-bottom: 5px;">Search</button></center> 
                     </a>
                 </div>
